...
Pushes Cowrie predictions to Elasticsearch
"""
...
POSSIBLE_CSV_PATHS = [
    "data/cowrie/predictions/cowrie_predictions.csv",  # Main prediction output
    "data/cowrie/predictions/train_predictions.csv",   # Legacy name
    "data/cowrie/predictions/anomaly_scores.csv",      # Scores only
]
...
def push():
    ...
    elif 'is_attacker' in df.columns:
        anomaly_col = 'is_attacker'
        anomaly_count = df['is_attacker'].sum()
    else:
        anomaly_col = None
        anomaly_count = 0
